...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'prodgroupcad', data: { breadcrumb: 'Cadastro Grupo Produtos' }, loadChildren: () => import('./prod-group-cad/prod-group-cad.module').then(m => m.ProdGroupCadModule) },
        { path: 'prodgrouplist', data: { breadcrumb: 'Busca Grupo Produtos' }, loadChildren: () => import('./prod-group-list/prod-group-list.module').then(m => m.ProdGroupListModule) },
